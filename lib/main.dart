  ...
  try {
    ...
    for (final topicData in targetTopics) {
      ...
      if (sourceUrl.isNotEmpty) {
        ...
        final bool isSocial = scraped['isSocial'] as bool? ?? false;

        if (isSocial) {
          embeddedSocialUrl = sourceUrl;
        }
      ...
      String mediaCredits = 'Generated by Platform';
      String mediaSource = 'AI Generated';
      if (sourceImages.isNotEmpty) {
        mediaSource = 'Official Source';
        if (sourceUrl.isNotEmpty) {
          try {
            final uri = Uri.parse(sourceUrl);
            mediaCredits = uri.host.replaceFirst('www.', '');
          } catch (_) {
            mediaCredits = 'Original Publisher';
          }
        } else {
          mediaCredits = 'Original Publisher';
        }
      }
      knowledge['mediaCredits'] = mediaCredits;
